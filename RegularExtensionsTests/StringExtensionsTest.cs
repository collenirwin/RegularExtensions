...
namespace RegExtensionsTest
{
    ...
    public class StringExtensionsTest
    {
        ...
        public void Join()
        {
            Assert.AreEqual("Hello world", new string[] { "Hello", "world" }.Join(" "));
            Assert.AreEqual(string.Join(" ", new string[] { "Hello", "world" }), new string[] { "Hello", "world" }.Join(" "));

            Assert.AreEqual("Hello", new string[] { "Hello" }.Join(" "));
            Assert.AreEqual(string.Join(" ", new string[] { "Hello" }), new string[] { "Hello" }.Join(" "));
        }
    }
}
